<template>
    ...
    <img src="../assets/images/foto-banner.png" alt="Foto de uma mulher cozinhando com uma bacia de video nas mãos. Ela está sorrindo e está apoiando um celular entre seu rosto e ombro."
    class="foto-banner">
  </header>
</template>
